...
require_once('gocoin/src/api/merchant.php');
require_once('gocoin/src/api/user.php');
require_once('gocoin/src/api/apps.php');
require_once('gocoin/src/api/invoices.php');
require_once('gocoin/src/api/accounts.php');
